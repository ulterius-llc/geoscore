...
import { ContinentBadges } from './ContinentBadges';
import { CountryBottomSheet } from './CountryBottomSheet';
import { CountryListPanel } from './CountryListPanel';
import { Footer } from './Footer';
import { useGeoScore } from './GeoScoreProvider';
...
export function GeoScoreApp() {
  const { t, i18n } = useTranslation();
  const { records, ready, map, setStatus, replaceAll, resetAll } =
    useGeoScore();
  ...
  useEffect(() => {
    // Reset transient UI state when switching maps.
